...
### Psicología - Asincrónica

Reunión de Bienvenida - Presentación del curso
...
📖 Ustedes leen el material *durante* los módulos

🏫 En cada encuentro sincrónico trabajamos sobre visto en módulos
...
El encuentro sincrónico no reemplaza la lectura ni las actividades.
...
Los encuentros son optativos. Quedan grabados durante 30 días.

</div>
::::

::: notes
Explicitar el contrato: leer antes es parte del trabajo. La clase se aprovecha distinto si llegan habiendo leído.
:::
...
| Necesitás... | Usá... |
|------------------------------------|------------------------------------|
| Saber qué hay que leer o hacer | **Módulos semanales** en Blackboard |
| Consultar una duda de contenido | **Mensaje** por Blackboard o Encuentro sincrónicos |
...
## El cronograma es tu aliado

:::::: columns
:::: {.column width="55%"}
<div>

-   Lo van a tener en Blackboard - Seguir los módulos
...
::: {.callout-important appearance="simple"}
Las *autoevaluaciones* son opcionales, pero sirven para que puedan ir midiendo cómo van en la materia.
:::
...
| **Formato**        | Desarrollo + opción múltiple   |
| **Duración**       | 50 minutos                     |
| **Para aprobar**   | Mínimo 4 (escala 1–10)         |
| **Día de parcial** | 24h de ventana para rendir     |

:::: {.callout-important appearance="simple"}
<div>

No hay sorpresas. El parcial evalúa lo que se trabaja en módulo y en las lecturas.
...
<br> <br>
[Seguir módulos · Pregunten en encuentros · Usen el cronograma]{style="color: #000000;"}
