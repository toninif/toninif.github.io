...
Se mide la "edad mental" —es decir, la inteligencia— y se aplica la fórmula.
...
![](img/ci-distribucion.png){width="92%"}
...
:::::: {.cols-2 style="margin-top:0.8em"}
::: {style="text-align:center"}
![](img/ci-hombres-mujeres.png){width="95%"}
:::
...
![](img/paper-llm-inteligencia.png){width="72%"}
