...
3. Configurar las variables públicas del proyecto.
4. Conectar la interfaz con autenticación y consultas reales.
5. Publicar esta carpeta en `evaluaciones.fernandotonini.com.ar`.
